...
const searchEntries=[['Giới thiệu RELOAD','about.html'],['Chi nhánh RELOAD WOMEN & RELOAD GYM','locations.html'],['Cơ sở vật chất & Thiết bị','facilities.html'],['Dịch vụ phòng gym','services.html'],['Lịch lớp & Boxing','class-schedule.html'],['Huấn luyện cá nhân','services.html#personal-training'],['Chăm sóc sức khỏe & Châm cứu','services.html#wellness'],['Bảng giá gói tập','membership.html'],['Kết quả hội viên','about.html#results'],['Tin tức RELOAD','blog.html'],['Chi nhánh','locations.html'],['Liên hệ & Đăng ký tập thử','locations.html#contact']];
